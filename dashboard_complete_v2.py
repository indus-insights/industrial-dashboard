...
with tab1:
    ...
    with col1:
        ...
        if st.button('', key='btn_kunde', help='Cliquer pour voir le graphique'):
            show_kunde_chart()
        
        color = 'green' if kunde_mist <= kunde_m_soll else 'red'
        status_class = 'status-good' if kunde_mist <= kunde_m_soll else 'status-bad'
        st.markdown(f"""
        <div class="metric-card {status_class} metric-card-clickable">
    ...
    # Supplier Complaints
    with col2:
        if st.button('', key='btn_liefer', help='Cliquer pour voir le graphique'):
            show_liefer_chart()
    ...
    # Risk Hunting
    with col3:
        if st.button('', key='btn_risk', help='Cliquer pour voir le graphique'):
            show_risk_chart()
    ...
    # FRTX
    with col4:
        if st.button('', key='btn_frtx', help='Cliquer pour voir le graphique'):
            show_frtx_chart()
    ...
    with col5:
        if st.button('', key='btn_cycle', help='Cliquer pour voir le graphique'):
            show_cycle_chart()
    ...
    with col7:
        if st.button('', key='btn_saa', help='Cliquer pour voir le graphique'):
            show_saa_chart()
    ...
    with col9:
        if st.button('', key='btn_abw', help='Cliquer pour voir le graphique'):
            show_abw_chart()
        ...
        st.markdown(f"""
        <div class="metric-card {status_class} metric-card-clickable" style="margin-top: 0px;">
