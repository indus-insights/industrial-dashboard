...
@st.cache_data(ttl=30) # 30 secondes - parfait pour les réunions
...
# ============================================
# BOUTON REFRESH EN BAS (ne décale rien)
# ============================================
st.markdown("<div style='height: 40px;'></div>", unsafe_allow_html=True)
col1, col2, col3 = st.columns([2, 1, 2])
with col2:
    if st.button("🔄 " + t['refresh_button'], type="primary", key="refresh_bottom", help=t['refresh_help'], use_container_width=True):
